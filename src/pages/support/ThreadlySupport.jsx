...
const faqs = [
  {
    ...
    a: 'You can delete your account directly inside the app by going to Settings > Account > Delete Account. This will instantly purge all your personal data, post content, reels, stories, and chat messages from our servers.'
  },
  {
    q: 'Why are my messages not delivering instantly?',
    a: 'Threadly uses a three-tier message delivery network. If the recipient is currently offline, the message is routed via Firebase Cloud Messaging (FCM). Ensure that the recipient has notification permissions enabled and background data usage turned on.'
  },
  {
    q: 'Can I upload high-definition videos for Reels?',
    a: 'Yes. Threadly automatically processes and compresses videos asynchronously using our background media pipeline. For best results, use standard MP4 format with H.264 encoding.'
  },
  {
    q: 'How do I report abusive content or users?',
    a: 'Tap the three dots on the top right of any post, story, or comment and select "Report". Our moderation team reviews reported items within 24 hours.'
  }
];

export default function ThreadlySupport() {
  ...
  return (
    <>
      <SEOHead
        title="Threadly Support Center — Help & Ticket Submission"
        description="Get help and submit support requests for the Threadly Android social media application."
      />
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      placeholder="Please specify issue details, error messages, or features you want to request..."
                      required
                      rows={6}
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-bg-elevated border border-border p-6 rounded-2xl shadow-sm">
                ...
                <p className="text-xs text-text-muted mb-4">
                  Read our privacy standards and user agreements governing the Threadly client and database operations.
                </p>
                <div className="space-y-3">
                  <Link
                    to="/apps/threadly/privacy"
